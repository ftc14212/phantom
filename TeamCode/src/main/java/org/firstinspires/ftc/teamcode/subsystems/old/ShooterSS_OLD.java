...
public class ShooterSS_OLD extends SubsystemBase {
    // -------------------------
    // VALUES STUFF
    // -------------------------
    ...
    // INIT THINGY
    // -------------------------
    public ShooterSS_OLD(PIDFCoefficients pid, CachingDcMotorEx shooter, CachingServo hood) {
        this.pid = pid;
        this.shooter = new CombinedDcMotorEx(shooter);
        this.hood = new CombinedServo(hood);
    }
    public ShooterSS_OLD(PIDFCoefficients pid, CachingDcMotorEx shooter, CachingServo hoodL, CachingServo hoodR) {
        this.pid = pid;
        this.shooter = new CombinedDcMotorEx(shooter);
        this.hood = new CombinedServo(hoodL, hoodR);
    }
    public ShooterSS_OLD(PIDFCoefficients pid, CachingDcMotorEx shooterL, CachingDcMotorEx shooterR, CachingServo hood) {
        this.pid = pid;
        this.shooter = new CombinedDcMotorEx(shooterL, shooterR);
        this.hood = new CombinedServo(hood);
    }
    public ShooterSS_OLD(PIDFCoefficients pid, CachingDcMotorEx shooterL, CachingDcMotorEx shooterR, CachingServo hoodL, CachingServo hoodR) {
        this.pid = pid;
        this.shooter = new CombinedDcMotorEx(shooterL, shooterR);
        this.hood = new CombinedServo(hoodL, hoodR);
    }
