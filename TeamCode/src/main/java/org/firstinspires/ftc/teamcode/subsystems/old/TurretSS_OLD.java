...
public class TurretSS_OLD extends SubsystemBase {
    // -------------------------
    // VALUES STUFF
    // -------------------------
    int TPR;
    ...
    // INIT THINGY
    // -------------------------
    public TurretSS_OLD(PIDController pid, double F, CRServo turret, DcMotorEx encoder, int TPR, double ratio) {
        this(pid, F, turret, encoder, TPR, ratio, 0);
    }
    public TurretSS_OLD(PIDController pid, double F, CRServo turret, DcMotorEx encoder, int TPR, double ratio, double offset) {
        this(pid, F, turret, encoder, TPR, ratio, offset, -999);
    }
    public TurretSS_OLD(PIDController pid, double F, CRServo turret, DcMotorEx encoder, int TPR, double ratio, double offset, double lastTurretPos) {
        // vars
        this.pid = pid;
        this.turret = turret;
    ...
    public TurretSS_OLD(PIDController pid, double F, CombinedCRServo turret, DcMotorEx encoder, int TPR, double ratio) {
        this(pid, F, turret, encoder, TPR, ratio, 0);
    }
    public TurretSS_OLD(PIDController pid, double F, CombinedCRServo turret, DcMotorEx encoder, int TPR, double ratio, double offset) {
        this(pid, F, turret, encoder, TPR, ratio, offset, -999);
    }
    public TurretSS_OLD(PIDController pid, double F, CombinedCRServo turret, DcMotorEx encoder, int TPR, double ratio, double offset, double lastTurretPos) {
        // vars
        this.pid = pid;
        this.turretC = turret;
        this.encoder = encoder;
